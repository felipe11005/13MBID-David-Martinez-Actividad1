...
with tab1:
    ...
    with col1:
        ...
        education = st.selectbox("Nivel Educativo", [
            "1-basic_school", "2-high_school",
            "0-illiterate", "3-professional_course", "4-university_degree"
        ])
                ...
                with res_col2:
                    ...
                    fig = go.Figure(data=[
                        go.Bar(
                            ...
                            textposition='auto',
                            marker_color=['#ff4b4b' if k == '0.0' else '#00cc00' for k in probabilities.keys()]
                        )
                    ])
                    ...
                    with prob_col1:
                        st.metric("Probabilidad NO", f"{probabilities.get('0.0', 0)*100:.2f}%")
                    with prob_col2:
                        st.metric("Probabilidad SÍ", f"{probabilities.get('1.0', 0)*100:.2f}%")
